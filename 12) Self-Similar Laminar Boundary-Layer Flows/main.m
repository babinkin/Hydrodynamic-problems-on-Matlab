...
disp(['Number of Programm 3.2 iterations : ' num2str(iter)])
...
figure(1)
plot(p, eta, 'o', v, eta, '+')
title('Distribution of dimensionless velocity components: Programm 3.2')
...
disp(['Number of Problem 3.1 iterations :' num2str(iter)])
